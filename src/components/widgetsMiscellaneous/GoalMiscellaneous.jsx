...
const goalData = [
    { value: 40, revenue: "₹46750/₹891250", title: "Marketing Goal", color: "#ea4d4d" },
    { value: 65, revenue: "₹4891/₹881510", title: "Teams Goal", color: "#3454d1" },
    { value: 50, revenue: "₹84541/₹8918250", title: "Leads Goal", color: "#ffa21d" },
    { value: 75, revenue: "₹86948/₹8851250", title: "Revenue Goal", color: "#17c666" }
];
                        ...
                        {goalData.map(({ color, revenue, title, value }, index) => (
                            <div key={index} className="col-sm-6">
                                <div className="px-4 py-3 text-center border border-dashed rounded-3 goal-card">
                                    ...
                                    <div className="fs-11 text-muted text-truncate-1-line">{revenue} INR</div>
                                </div>
                            </div>
                        ))}
                    </div>
